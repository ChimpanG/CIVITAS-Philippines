...
VALUES	(
		...
		'ICON_CIVILIZATION_CVS_PHILIPPINES_KUDARAT', -- CivilizationIcon
		...
		'ICON_CIVILIZATION_CVS_PHILIPPINES_KUDARAT', -- CivilizationAbilityIcon
...
VALUES 	('CIVILIZATION_CVS_PHILIPPINES',	'LEADER_CVS_KUDARAT',	'UNIT_CVS_PHILIPPINES_UU',		'ICON_UNIT_CVS_PHILIPPINES_UU',			'LOC_UNIT_CVS_PHILIPPINES_UU_NAME',			'LOC_UNIT_CVS_PHILIPPINES_UU_DESCRIPTION',		10			),
		...
		('CIVILIZATION_CVS_PHILIPPINES',	'LEADER_CVS_KUDARAT',	'DISTRICT_CVS_KUDARAT_UI',		'ICON_DISTRICT_CVS_KUDARAT_UI',			'LOC_DISTRICT_CVS_KUDARAT_UI_NAME',			'LOC_DISTRICT_CVS_KUDARAT_UI_DESCRIPTION',		30			);
...
VALUES 	('Players:Expansion1_Players',	'CIVILIZATION_CVS_PHILIPPINES',	'LEADER_CVS_KUDARAT',	'UNIT_CVS_PHILIPPINES_UU',		'ICON_UNIT_CVS_PHILIPPINES_UU',			'LOC_UNIT_CVS_PHILIPPINES_UU_NAME',			'LOC_UNIT_CVS_PHILIPPINES_UU_DESCRIPTION',		10			),
		...
		('Players:Expansion1_Players',	'CIVILIZATION_CVS_PHILIPPINES',	'LEADER_CVS_KUDARAT',	'DISTRICT_CVS_KUDARAT_UI',		'ICON_DISTRICT_CVS_KUDARAT_UI',			'LOC_DISTRICT_CVS_KUDARAT_UI_NAME',			'LOC_DISTRICT_CVS_KUDARAT_UI_DESCRIPTION',		30			);
